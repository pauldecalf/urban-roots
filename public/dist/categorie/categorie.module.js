...
const categorie_schema_1 = require("./schemas/categorie.schema");
...
exports.CategorieModule = CategorieModule = __decorate([
    (0, common_1.Module)({
        imports: [mongoose_1.MongooseModule.forFeature([{ name: 'Categorie', schema: categorie_schema_1.CategorieSchema }])],
        providers: [categorie_service_1.CategorieService],
        controllers: [categorie_controller_1.CategorieController],
        exports: [categorie_service_1.CategorieService]
    })
], CategorieModule);
