...
export declare class LikeCommentaireService {
    private readonly likeCommentaireModel;
    constructor(likeCommentaireModel: Model<likeCommentaire>);
    create(createlikeCommentaireDto: CreateLikeCommentaireDto): Promise<likeCommentaire>;
    findAll(): Promise<likeCommentaire[]>;
    findOne(id: string): Promise<likeCommentaire>;
}
