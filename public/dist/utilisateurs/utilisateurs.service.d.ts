...
export declare class UtilisateursService {
    private readonly utilisateurModel;
    constructor(utilisateurModel: Model<Utilisateur>);
    create(createUtilisateurDto: CreateUtilisateurDto): Promise<Utilisateur>;
    findAll(): Promise<Utilisateur[]>;
    countAll(): Promise<number>;
    findOne(id: string): Promise<Utilisateur>;
    findOneByEmail(email: string): Promise<Utilisateur | undefined>;
    update(id: string, user: Partial<Utilisateur>): Promise<Utilisateur>;
}
