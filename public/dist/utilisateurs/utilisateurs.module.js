...
const utilisateur_schema_1 = require("./schemas/utilisateur.schema");
...
exports.UtilisateursModule = UtilisateursModule = __decorate([
    (0, common_1.Module)({
        imports: [mongoose_1.MongooseModule.forFeature([{ name: 'Utilisateur', schema: utilisateur_schema_1.UtilisateurSchema }])],
