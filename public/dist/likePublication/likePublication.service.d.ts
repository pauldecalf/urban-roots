...
export declare class LikePublicationService {
    private readonly likePublicationModel;
    constructor(likePublicationModel: Model<likePublication>);
    create(createlikePublicationDto: CreateLikePublicationDto): Promise<likePublication>;
    findAll(): Promise<likePublication[]>;
    findOne(id: string): Promise<likePublication>;
}
